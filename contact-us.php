    ...
    <div class="container">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href="./products.php"><i class="fa fa-mobile"></i><span>Products</span></a></li>
                <li><a href="./about.php"><i class="fa fa-user"></i><span>About Us</span></a></li>
                <li class="active"><a href="./contact-us.php"><i class="fa fa-info"></i><span>Contact</span></a></li>
            </ul>
